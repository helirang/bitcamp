...
namespace _64_NetworkStreamMultiThreadClientForm
{
    public partial class Form1 : Form
    {
        ...
        private void btnBaseBallStart_Click(object sender, EventArgs e)
        {
            SendData("B|S");
        }

        private void btnBaseBallRun_Click(object sender, EventArgs e)
        {
            string data = String.Format("B|R|{0}|{1}|{2}", 
                Int32.Parse(tbNum0.Text),
                Int32.Parse(tbNum1.Text),
                Int32.Parse(tbNum2.Text));
            SendData(data);
        }
    }
}
